...
class SearchBar extends StatefulWidget {
  const SearchBar({Key key, this.func1}) : super(key: key);
  final func1;
...
class _SearchBarState extends State<SearchBar> {
  ...
  Future predict(File image) async {
    ...
    print(recognitions[0]['label'].toString().toUpperCase());
    widget.func1(recognitions[0]['label'].toString(), image);
